...
import copy
from board1 import maze_A, maze_B, maze_C, maze_D, maze_E, maze_F,maze_G,maze_H, original_board
import pygame
import math

pygame.init()
boards = [maze_H,maze_G,maze_F, maze_E, maze_D, maze_C, maze_B, maze_A, original_board]
WIDTH = 900
HEIGHT = 950
